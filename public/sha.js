...
(function(L) {
  function u(d, b, h) {
    ...
    if (0 === d.lastIndexOf("SHA3-", 0) || 0 === d.lastIndexOf("SHAKE", 0)) {
      ...
      p = function(c, a, e, g, d) {
        ...
        var b = C,
          ...
          h = 0,
          r = a >>> 5;
        for (m = 0; m < r && a >= e; m += f) g = B(c.slice(m, m + f), g), a -= e;
        c = c.slice(m);
    ...
    this.setHMACKey = function(a, b, l) {
      ...
      for (a = 0; a <= l; a += 1) n[a] = b[a] ^ 909522486, u[a] = b[a] ^ 1549556828;
      m = f(n, m);
      c = k;
      A = !0
    };
    this.update = function(e) {
      ...
      g = b.value;
      b = e >>> 5;
      for (d = 0; d < b; d += p) h + k <= e && (m = f(g.slice(d, d + p), m), h += k);
      c += h;
      a = g.slice(h >>> 5);
      l = e % k;
      z = !0
    ...
    this.getHash = function(e, b) {
      ...
      r = E(b);
      if (!0 === x) {
        if (-1 === r.shakeLen) throw Error("shakeLen must be specified in options");
        g = r.shakeLen
      }
      switch (e) {
        case "HEX":
      ...
      for (f = 1; f < w; f += 1) !0 === x && 0 !== g % 32 && (k[k.length - 1] &= 16777215 >>> 24 - g % 32), k = p(k, g, 0, y(d), g);
      return h(k)
    };
  ...
  function F(d,
    ...
    var l, e, m;
    m = -1 === h ? 3 : 0;
    for (l = 0; l < b; l += 1) e = d[l >>> 2] >>> 8 * (m + l % 4 * h), a += "0123456789abcdef".charAt(e >>> 4 & 15) + "0123456789abcdef".charAt(e & 15);
  ...
  function G(d, b, h, c) {
    ...
    g = -1 === h ? 3 : 0;
    for (e = 0; e < l; e += 3)
      for (m = e + 1 < l ? d[e + 1 >>> 2] : 0, f = e + 2 < l ? d[e + 2 >>> 2] : 0, f = (d[e >>> 2] >>> 8 * (g + e % 4 * h) & 255) << 16 | (m >>> 8 * (g + (e + 1) % 4 * h) & 255) << 8 | f >>> 8 * (g + (e + 2) % 4 * h) & 255, m = 0; 4 > m; m += 1) 8 * e + 6 * m <= b ? a += "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(f >>>
        6 * (3 - m) & 63) : a += c.b64Pad;
    return a
  }
  ...
  function H(d, b, h) {
    ...
    var a, l, e;
    e = -1 === h ? 3 : 0;
    for (a = 0; a < b; a += 1) l = d[a >>> 2] >>> 8 * (e + a % 4 * h) & 255, c += String.fromCharCode(l);
    return c
  }
  ...
  function I(d, b, h) {
    ...
    e = new Uint8Array(a);
    l = -1 === h ? 3 : 0;
    for (c = 0; c < b; c += 1) e[c] = d[c >>> 2] >>> 8 * (l + c % 4 * h) & 255;
    return a
  }
  ...
  function E(d) {
    ...
    if (!0 === d.hasOwnProperty("shakeLen")) {
      if (0 !==
        d.shakeLen % 8) throw Error("shakeLen must be a multiple of 8");
    ...
    switch (d) {
        ...
        d =
          function(c, a, b) {
            ...
            for (f = 0; f < c.length; f += 4) {
              q = c.substr(f, 4);
              for (g = k = 0; g < q.length; g += 1) d = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".indexOf(q[g]), k |= d << 18 - 6 * g;
      ...
      case "BYTES":
        d = function(c, a, b) {
          ...
          f = b >>> 3;
          n = -1 === h ? 3 : 0;
          for (d = 0; d < c.length; d += 1) e = c.charCodeAt(d), k = d + f, g = k >>> 2, a.length <= g && a.push(0), a[g] |= e << 8 * (n + k % 4 * h);
          return {
            value: a,
            binLen: 8 * c.length + b
          }
      ...
      case "ARRAYBUFFER":
        ...
        d = function(c, a, b) {
          ...
          k = -1 === h ? 3 : 0;
          q = new Uint8Array(c);
          for (d = 0; d < c.byteLength; d += 1) g = d + f, n = g >>> 2, a.length <= n && a.push(0), a[n] |= q[d] << 8 * (k + g % 4 * h);
          return {
            value: a,
  ...
  function y(d) {
    var b = [];
    if (0 === d.lastIndexOf("SHA3-", 0) || 0 === d.lastIndexOf("SHAKE", 0))
      for (d = 0; 5 > d; d += 1) b[d] = [new f(0, 0), new f(0, 0), new f(0, 0), new f(0, 0), new f(0, 0)];
  ...
  function B(d, b) {
    var h, c, a, l, e = [],
      m = [];
    if (null !== d)
      for (c = 0; c < d.length; c += 2) b[(c >>> 1) % 5][(c >>> 1) / 5 | 0] = n(b[(c >>> 1) % 5][(c >>> 1) / 5 | 0], new f(d[c + 1], d[c]));
    for (h = 0; 24 > h; h += 1) {
      l = y("SHA3-");
      for (c = 0; 5 > c; c += 1) {
        a = b[c][0];
      ...
      for (c = 0; 5 > c; c += 1)
        for (a = 0; 5 > a; a += 1) b[c][a] =
          n(b[c][a], m[c]);
      for (c = 0; 5 > c; c += 1)
        for (a = 0; 5 > a; a += 1) l[a][(2 * c + 3 * a) % 5] = z(b[c][a], J[c][a]);
      for (c = 0; 5 > c; c += 1)
        for (a = 0; 5 > a; a += 1) b[c][a] = n(l[c][a], new f(~l[(c + 1) % 5][a].a & l[(c + 2) % 5][a].a, ~l[(c + 1) % 5][a].b & l[(c + 2) % 5][a].b));
      b[0][0] = n(b[0][0], K[h])
    }
    return b
  }
